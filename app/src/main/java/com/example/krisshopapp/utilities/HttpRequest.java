 ...
 * MainActivity goals: to make it intuitive, short, clean and reasonable.
...
public class HttpRequest {
    ...
    //For InputStream
    public Object sendAndReadStream() throws IOException{
        //BufferedReader br=new BufferedReader(new InputStreamReader(con.getInputStream()));
        //String line,response="";
        //while ((line=br.readLine()) != null)response+=line;
        //done();
    ...
    //For InputStream
    public HttpRequest prepareStream()throws IOException{
        con = (HttpURLConnection) url.openConnection();
